// ================================================================
// Dhunterhub app.js — Clean Focused Build
// Auth: Amy-verified PKCE (DO NOT CHANGE)
// ================================================================

const DERIV_CLIENT_ID = "33LUhwGjAcZNaEdEtEzT0";
const DERIV_APP_ID    = "33LUhwGjAcZNaEdEtEzT0";
// Auto-detect domain — works for both Dhunterhub.com AND Dhunterhub.vercel.app
// Both must be registered as redirect URIs in your Deriv app dashboard
const DERIV_REDIRECT = (
    window.location.hostname === 'Dhunterhub.com' ||
    window.location.hostname === 'www.Dhunterhub.com'
) ? 'https://Dhunterhub.com/' : 'https://Dhunterhub.vercel.app/';
...
function downloadTransactions() {
    ...
    a.download = `Dhunterhub_transactions_${new Date().toISOString().slice(0,10)}.csv`;
    a.click();
}
...
<p>By accessing or using Dhunterhub ("the Platform"), you agree to be bound by these Terms of Service. If you do not agree, do not use the Platform.</p>

<h4 style="color:#00d2c8;margin:14px 0 6px;">2. Description of Service</h4>
<p>Dhunterhub is a third-party trading interface that connects to the Deriv API. We provide automated trading tools, market analysis, and AI-powered signals. We are not affiliated with, endorsed by, or part of Deriv Ltd.</p>
...
<p>Nothing on Dhunterhub constitutes financial, investment, or trading advice. All AI signals, market analysis, and bot strategies are for informational purposes only. You trade at your own risk.</p>
...
<p>Dhunterhub, its owners, developers, and affiliates shall not be liable for any trading losses, lost profits, or damages arising from the use of this Platform, including but not limited to losses caused by bot malfunction, API errors, connectivity issues, or market conditions.</p>
...
<p style="margin-top:16px;color:#4a5568;font-size:11px;">For questions: support@Dhunterhub.com</p>`
    },
...
<p>Dhunterhub does <b style="color:#e2e8f0;">not</b> collect, store, or process your personal data on our servers. All authentication is handled directly between your browser and Deriv's servers via OAuth 2.0 PKCE.</p>
...
<p>Dhunterhub does not use cookies or tracking technologies.</p>
...
<p>Dhunterhub participates in the Deriv affiliate program. When you create a new Deriv account through our platform, we may receive a commission. This does not affect your trading costs or experience.</p>

<h4 style="color:#00d2c8;margin:14px 0 6px;">7. Contact</h4>
<p>For privacy concerns: <a href="mailto:support@Dhunterhub.com" style="color:var(--teal);">support@Dhunterhub.com</a></p>`
    },
...
<p>Automated trading bots, including those provided or configured on Dhunterhub, carry additional risks:</p>
<ul style="margin:6px 0 6px 20px;">
...
<p>Dhunterhub is a third-party tool and is not regulated by any financial authority. Trading through Deriv is subject to Deriv's own regulatory framework. Please ensure trading is legal in your jurisdiction.</p>

<h4 style="color:#00d2c8;margin:14px 0 6px;">6. No Guarantee of Profit</h4>
<p>Dhunterhub makes no representation or warranty that use of the platform will result in profits. All trading results depend on market conditions, your settings, and factors beyond our control.</p>

<div style="background:#00d2c814;border:1px solid #00d2c844;border-radius:8px;padding:14px;margin-top:16px;">
    <p style="color:#00d2c8;font-weight:700;">✅ By using Dhunterhub, you confirm that:</p>
